...
import { createProject } from "../features/projects/services/createProject";
...
export default function CreateProject() {
  ...
  const submitHandler = (data: ProjectData) => {
    ...
    createProject(titleFormatted, descriptionFormatted, myRoleFormatted).then((response) => console.log(response));
  };
  return (
    <Box
      ...
      <Stack
        ...
        <Box>
          <TextField
            ...
            helperText={
              errors.title ? errorTypes[errors.title.type as keyof typeof errorTypes] : "* Must not be empty."
            }
            sx={{
              minWidth: "300px",
            }}
